	...
	<div class="col-lg-12">
		<div class="box">
			<div class="box-header">
				<h2><i class="icon-edit"></i><?php echo __('Edit User') ?></h2>
			</div>
...
<!-- company name -->
					<div class="form-group">
					  <label class="control-label" for="date"><?php echo $this -> Html -> tag('span', __('Company')); ?></label>
					  <div class="controls row">
						<div class="input-group col-sm-4">
...
<!-- name -->
					<div class="form-group">
					  <label class="control-label" for="date"><?php echo $this -> Html -> tag('span', __('Name')); ?></label>
					  <div class="controls row">
						<div class="input-group col-sm-4">
					...
					<div class="form-group">
						...
						<div class="controls row">
							<div class="input-group col-sm-4">
								...
								<?php echo $this -> Form -> input('password', array('label' => FALSE, 'class' => 'form-control', 'required' => False, 'type' => 'text')); ?>
							</div>
