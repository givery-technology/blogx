...
<div class="container">
	...
	<!-- <a class="navbar-brand col-lg-2 col-sm-1 col-xs-12" href="<?php echo $this->webroot; ?>"><span style="font-size: 18px; font-family: 'Cinzel Decorative', cursive;"><?php echo Configure::read('SYSTEM_NAME'); ?></span></a> -->
	<a class="navbar-brand col-lg-2 col-sm-1 col-xs-12" href="<?php echo $this->webroot; ?>"><span style="font-size: 18px; font-family: 'Cinzel Decorative', cursive;"><?php echo Configure::read('SYSTEM_NAME'); ?></span></a>
	<!-- start: Header Menu -->
